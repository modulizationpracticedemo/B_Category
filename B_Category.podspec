...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/modulizationpracticedemo/B_Category"
  ...
  s.source       = { :git => "https://github.com/modulizationpracticedemo/B_Category.git", :tag => s.version.to_s }
